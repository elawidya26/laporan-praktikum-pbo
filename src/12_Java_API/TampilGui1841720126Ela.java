 ...
 * @author Ela Widya
 */
public class TampilGui1841720126Ela extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720126Ela DataMahasiswa;

    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720126Ela() {
        DataMahasiswa = new InputData1841720126Ela();
        initComponents();
        LihatDataMahasiswa();
    }
    ...
    public final void LihatDataMahasiswa() {
        ...
        int i = 0;
        for(Mahasiswa1841720126Ela mhs: DataMahasiswa.getData()) {
            String arrayMahasiswa[] = {mhs.getNimEla(), mhs.getNamaEla(), mhs.getAlamatEla()};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DataMahasiswa.isiDataEla(jTextFieldNim.getText(), jTextFieldNama.getText(), jTextAlamat.getText());
        LihatDataMahasiswa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720126Ela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720126Ela().setVisible(true);
            }
        });
    }

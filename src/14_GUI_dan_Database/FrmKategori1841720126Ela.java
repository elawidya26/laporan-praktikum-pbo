 ...
 * @author Ela Widya
 */
public class FrmKategori1841720126Ela extends javax.swing.JFrame {

    /**
     * Creates new form FrmKategori1841720126Ela
     */
    public FrmKategori1841720126Ela() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Kategori1841720126Ela> list = new Kategori1841720126Ela().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1841720126Ela kat : list){
            rowData[0] = kat.getIdKategoriEla();
            rowData[1] = kat.getNamaEla();
            rowData[2] = kat.getKeteranganEla();
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720126Ela> list = new Kategori1841720126Ela().search(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        kat.setIdKategoriEla(Integer.parseInt(txtIdKategori.getText()));
        kat.setNamaEla(txtNama.getText());
        kat.setKeteranganEla(txtKeterangan.getText());
        kat.saveEla();
        txtIdKategori.setText(Integer.toString(kat.getIdKategoriEla()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720126Ela kat = new Kategori1841720126Ela().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.deleteEla();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1841720126Ela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720126Ela().setVisible(true);
            }
        });
    }

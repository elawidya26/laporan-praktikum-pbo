 ...
 * @author Ela Widya
 */
public class FrmPeminjaman1841720126Ela extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman1841720126Ela
     */
    public FrmPeminjaman1841720126Ela() {
        initComponents();
        tampilkanDataEla();
        kosongkanFormEla();
    }
    
    public void kosongkanFormEla(){
    ...
    public void tampilkanDataEla(){
        String[] kolom = {"ID", "Anggota", "Buku", "Tanggal Pinjam", "Tanggal Kembali"};
        ArrayList<Peminjaman1841720126Ela> list = new Peminjaman1841720126Ela().getAllEla();
        Object rowData[] = new Object[5];
        
        tblPeminjaman.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getIdpeminjamanEla();
            rowData[1] = list.get(i).getAnggotaEla().getNamaEla();
            rowData[2] = list.get(i).getBukuEla().getJudulEla();
            rowData[3] = list.get(i).getTanggalpinjamEla();
            rowData[4] = list.get(i).getTanggalkembaliEla();
    ...
    public void cariAnggotaEla(String keyword){
        Anggota1841720126Ela anggota = new Anggota1841720126Ela().getByIdEla(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNamaEla());
    }
    
    public void cariBuku(String keyword){
        Buku1841720126Ela buku = new Buku1841720126Ela().getById(Integer.parseInt(keyword));
        jLabel7.setText("Judul Buku : "+buku.getJudulEla());
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720126Ela pmj = new Peminjaman1841720126Ela();
        pmj.setIdpeminjamanEla(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720126Ela anggota = new Anggota1841720126Ela().getByIdEla(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720126Ela buku = new Buku1841720126Ela().getById(Integer.parseInt(txtIdBuku.getText()));
        
        pmj.setAnggotaEla(anggota);
        pmj.setBukuEla(buku);
        pmj.setTanggalpinjamEla(txtTanggalPinjam.getText());
        pmj.setTanggalkembaliEla(txtTanggalKembali.getText());
        pmj.saveEla();
        txtIdPeminjaman.setText(Integer.toString(pmj.getIdpeminjamanEla()));
        tampilkanDataEla();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720126Ela pmj = new Peminjaman1841720126Ela().getByIdEla(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.deleteEla();
        kosongkanFormEla();
        tampilkanDataEla();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        cariAnggotaEla(txtIdAnggota.getText());
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        txtIdAnggota.setText(String.valueOf(pmj.getAnggotaEla().getIdAnggotaEla()));
        jLabel6.setText("Nama Anggota : "+pmj.getAnggotaEla().getNamaEla());
        
        txtIdBuku.setText(String.valueOf(pmj.getBukuEla().getIdbukuEla()));
        jLabel7.setText("Judul Buku : "+pmj.getBukuEla().getJudulEla());
        
        txtTanggalPinjam.setText(pmj.getTanggalpinjamEla());
        txtTanggalKembali.setText(pmj.getTanggalkembaliEla());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720126Ela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720126Ela().setVisible(true);
            }
        });
    }
